...
function rollupBundleFile(opts) {
  return __awaiter(this, void 0, void 0, function*() {
    ...
    const externalModuleIdStrategy = new external_module_id_strategy_1.ExternalModuleIdStrategy(
      opts.format,
      opts.dependencyList
    );
    // Create the bundle
    ...
    return Promise.all([
      fs_extra_1.outputJson(sourcemapFullFile, result.map),
      fs_extra_1.outputFile(opts.dest, result.code)
    ]);
  });
}
