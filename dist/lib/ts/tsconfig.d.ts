 ...
 */
export declare const initializeTsConfig: (
  defaultTsConfig: ng.ParsedConfiguration,
 ...
 */
export declare function setDependenciesTsConfigPaths(
  parsedTsConfig: ng.ParsedConfiguration,
  entryPoints: EntryPointNode[],
  pointToSource?: boolean
): any;
