 ...
 */
const resolveUserPackage = folderPathOrFilePath =>
  __awaiter(this, void 0, void 0, function*() {
    const readConfigFile = filePath =>
      __awaiter(this, void 0, void 0, function*() {
        return fs_extra_1.pathExistsSync(filePath) ? Promise.resolve().then(() => require(filePath)) : undefined;
      });
...
const primaryEntryPoint = ({ packageJson, ngPackageJson, basePath }) =>
  new entry_point_1.NgEntryPoint(packageJson, ngPackageJson, instantiateSchemaClass(ngPackageJson), basePath);
/**
 ...
 */
const findSecondaryPackagesPaths = (directoryPath, excludeFolder) =>
  __awaiter(this, void 0, void 0, function*() {
    const ignore = [
      '**/node_modules/**',
      '**/.git/**',
...
exports.discoverPackages = ({ project }) =>
  __awaiter(this, void 0, void 0, function*() {
